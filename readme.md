...
- Code was not following SOLID principles. Get Method in constructor was responsible in doing a DB connection, processing and returning results i.e. violating the Single-Responsibility principle as well as the dependency inversion principle.
